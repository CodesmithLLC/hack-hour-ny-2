...
function comb(arr, result){
  // const done = arr.reduce((ways) => { return done && ways.length === 0; }, true)
...
function getPINs(observed) {
  ...
  // split each of observed into possible
  const temp = observed.split('').map((num) => {
    const index = parseInt(num, 10);
    return poss[index];
  })

  const combArr = comb(temp, []);
  return Object.keys(combArr.reduce((obj, nums) => {
    obj[nums] = true;
    return obj;
  }, {}));
}
...
// console.log(["339","366","399","658","636","258","268","669","668","266","369","398","256","296","259","368","638","396","238","356","659","639","666","359","336","299","338","696","269","358","656","698","699","298","236","239"].length)
